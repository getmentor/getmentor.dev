...
ARG NEXT_PUBLIC_ALLOY_ENDPOINT
ARG NEXT_PUBLIC_SERVICE_NAME
...
ENV NEXT_PUBLIC_ALLOY_ENDPOINT=$NEXT_PUBLIC_ALLOY_ENDPOINT
ENV NEXT_PUBLIC_SERVICE_NAME=$NEXT_PUBLIC_SERVICE_NAME
