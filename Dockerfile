...
ARG RECAPTCHA_V2_SECRET_KEY
ARG MENTORS_API_LIST_AUTH_TOKEN
ARG MENTORS_API_LIST_AUTH_TOKEN_INNO
ARG MENTORS_API_LIST_AUTH_TOKEN_AIKB
ARG REVALIDATE_SECRET_TOKEN
ARG AZURE_STORAGE_DOMAIN
ARG NEXT_PUBLIC_AZURE_STORAGE_DOMAIN
ARG INTERTNAL_MENTORS_API

ENV AIRTABLE_API_KEY=$AIRTABLE_API_KEY
ENV AIRTABLE_BASE_ID=$AIRTABLE_BASE_ID
ENV NEXT_PUBLIC_RECAPTCHA_V2_SITE_KEY=$NEXT_PUBLIC_RECAPTCHA_V2_SITE_KEY
ENV RECAPTCHA_V2_SECRET_KEY=$RECAPTCHA_V2_SECRET_KEY
ENV MENTORS_API_LIST_AUTH_TOKEN=$MENTORS_API_LIST_AUTH_TOKEN
ENV MENTORS_API_LIST_AUTH_TOKEN_INNO=$MENTORS_API_LIST_AUTH_TOKEN_INNO
ENV MENTORS_API_LIST_AUTH_TOKEN_AIKB=$MENTORS_API_LIST_AUTH_TOKEN_AIKB
...
ENV INTERTNAL_MENTORS_API=$INTERTNAL_MENTORS_API
