          ...
          {submitStatus === 'success' && (
            <div className="mb-8 p-6 bg-green-50 border border-green-200 rounded-lg">
              ...
              <p className="text-green-700">
                Мы получили вашу регистрацию и рассмотрим её в ближайшее время. Обычно процесс
                модерации занимает 1-3 дня. Мы свяжемся с вами по указанному Telegram, как только
                ваш профиль будет одобрен.
              </p>
            </div>
          )}
